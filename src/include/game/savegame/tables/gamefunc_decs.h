...
extern void Com_sprintf ( char * dest , q_int32_t size , char * fmt , ... ) ;
extern q_int32_t Q_strcasecmp ( char * s1 , char * s2 ) ;
extern q_int32_t Q_strncasecmp ( char * s1 , char * s2 , q_int32_t n ) ;
extern q_int32_t Q_stricmp ( const char * s1 , const char * s2 ) ;
extern void Com_PageInMemory ( byte * buffer , q_int32_t size ) ;
...
extern q_int32_t LongNoSwap ( q_int32_t l ) ;
extern q_int32_t LongSwap ( q_int32_t l ) ;
extern q_int16_t ShortNoSwap ( q_int16_t l ) ;
extern q_int16_t ShortSwap ( q_int16_t l ) ;
...
extern q_int32_t Q_log2 ( q_int32_t val ) ;
...
extern q_int32_t VectorCompare ( vec3_t v1 , vec3_t v2 ) ;
extern void AddPointToBounds ( vec3_t v , vec3_t mins , vec3_t maxs ) ;
extern void ClearBounds ( vec3_t mins , vec3_t maxs ) ;
extern q_int32_t BoxOnPlaneSide2 ( vec3_t emins , vec3_t emaxs , struct cplane_s * p ) ;
...
extern void Blaster_Fire ( edict_t * ent , vec3_t g_offset , q_int32_t damage , qboolean hyper , q_int32_t effect ) ;
...
extern void Weapon_Generic ( edict_t * ent , q_int32_t FRAME_ACTIVATE_LAST , q_int32_t FRAME_FIRE_LAST , q_int32_t FRAME_IDLE_LAST , q_int32_t FRAME_DEACTIVATE_LAST , q_int32_t * pause_frames , q_int32_t * fire_frames , void ( * fire ) ( edict_t * ent ) ) ;
...
extern void PlayerNoise ( edict_t * who , vec3_t where , q_int32_t type ) ;
...
extern q_uint32_t CheckBlock ( void * b , q_int32_t c ) ;
...
extern void body_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void player_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void player_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void tank_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void tank_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void supertank_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void supertank_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void soldier_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void soldier_fire ( edict_t * self , q_int32_t flash_number ) ;
extern void soldier_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void parasite_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void parasite_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void mutant_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void mutant_dead ( edict_t * self ) ;
extern void mutant_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void medic_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void medic_dead ( edict_t * self ) ;
extern void medic_fire_blaster ( edict_t * self ) ;
extern void medic_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void insane_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void insane_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void infantry_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void infantry_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void hover_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void hover_dead ( edict_t * self ) ;
extern void hover_deadthink ( edict_t * self ) ;
extern void hover_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void gunner_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void gunner_dead ( edict_t * self ) ;
extern void gunner_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void gladiator_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void gladiator_dead ( edict_t * self ) ;
extern void gladiator_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void flyer_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void flyer_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void flyer_fire ( edict_t * self , q_int32_t flash_number ) ;
...
extern void floater_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void floater_dead ( edict_t * self ) ;
extern void floater_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void flipper_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void flipper_sight ( edict_t * self , edict_t * other ) ;
extern void flipper_dead ( edict_t * self ) ;
extern void flipper_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void chick_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void chick_dead ( edict_t * self ) ;
extern void chick_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void brain_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void brain_dead ( edict_t * self ) ;
extern void brain_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void makron_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void makron_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void jorg_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void jorg_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void boss2_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void boss2_dead ( edict_t * self ) ;
extern void boss2_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void berserk_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void berserk_dead ( edict_t * self ) ;
extern void berserk_pain ( edict_t * self , edict_t * other , float kick , q_int32_t damage ) ;
...
extern void fire_bfg ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t speed , float damage_radius ) ;
...
extern void fire_rail ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick ) ;
extern void fire_rocket ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t speed , float damage_radius , q_int32_t radius_damage ) ;
extern void rocket_touch ( edict_t * ent , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_grenade2 ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t speed , float timer , float damage_radius , qboolean held ) ;
extern void fire_grenade ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t speed , float timer , float damage_radius ) ;
...
extern void fire_blaster ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t speed , q_int32_t effect , qboolean hyper ) ;
extern void blaster_touch ( edict_t * self , edict_t * other , cplane_t * plane , csurface_t * surf ) ;
extern void fire_shotgun ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick , q_int32_t hspread , q_int32_t vspread , q_int32_t count , q_int32_t mod ) ;
extern void fire_bullet ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick , q_int32_t hspread , q_int32_t vspread , q_int32_t mod ) ;
extern void fire_lead ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick , q_int32_t te_impact , q_int32_t hspread , q_int32_t vspread , q_int32_t mod ) ;
extern qboolean fire_hit ( edict_t * self , vec3_t aim , q_int32_t damage , q_int32_t kick ) ;
extern void check_dodge ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t speed ) ;
...
extern edict_t * G_Find ( edict_t * from , q_int32_t fieldofs , char * match ) ;
...
extern void turret_driver_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern q_int32_t SV_FlyMove ( edict_t * ent , float time , q_int32_t mask ) ;
extern q_int32_t ClipVelocity ( vec3_t in , vec3_t normal , vec3_t out , float overbounce ) ;
...
extern void monster_fire_bfg ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t speed , q_int32_t kick , float damage_radius , q_int32_t flashtype ) ;
extern void monster_fire_railgun ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick , q_int32_t flashtype ) ;
extern void monster_fire_rocket ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t speed , q_int32_t flashtype ) ;
extern void monster_fire_grenade ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t speed , q_int32_t flashtype ) ;
extern void monster_fire_blaster ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t speed , q_int32_t flashtype , q_int32_t effect ) ;
extern void monster_fire_shotgun ( edict_t * self , vec3_t start , vec3_t aimdir , q_int32_t damage , q_int32_t kick , q_int32_t hspread , q_int32_t vspread , q_int32_t count , q_int32_t flashtype ) ;
extern void monster_fire_bullet ( edict_t * self , vec3_t start , vec3_t dir , q_int32_t damage , q_int32_t kick , q_int32_t hspread , q_int32_t vspread , q_int32_t flashtype ) ;
...
extern void misc_deadsoldier_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void barrel_delay ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void func_explosive_explode ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void debris_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
extern void ThrowClientHead ( edict_t * self , q_int32_t damage ) ;
extern void ThrowHead ( edict_t * self , char * gibname , q_int32_t damage , q_int32_t type ) ;
extern void ThrowGib ( edict_t * self , char * gibname , q_int32_t damage , q_int32_t type ) ;
extern void gib_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void VelocityForDamage ( q_int32_t damage , vec3_t v ) ;
...
extern q_int32_t PowerArmorType ( edict_t * ent ) ;
extern qboolean Pickup_Armor ( edict_t * ent , edict_t * other ) ;
extern q_int32_t ArmorIndex ( edict_t * ent ) ;
...
extern qboolean Add_Ammo ( edict_t * ent , gitem_t * item , q_int32_t count ) ;
...
extern gitem_t * GetItemByIndex ( q_int32_t index ) ;
...
extern void door_secret_die ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void door_killed ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void button_killed ( edict_t * self , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern void T_RadiusDamage ( edict_t * inflictor , edict_t * attacker , float damage , edict_t * ignore , float radius , q_int32_t mod ) ;
extern void T_Damage ( edict_t * targ , edict_t * inflictor , edict_t * attacker , vec3_t dir , vec3_t point , vec3_t normal , q_int32_t damage , q_int32_t knockback , q_int32_t dflags , q_int32_t mod ) ;
extern void M_ReactToDamage ( edict_t * targ , edict_t * attacker ) ;
extern q_int32_t CheckArmor ( edict_t * ent , vec3_t point , vec3_t normal , q_int32_t damage , q_int32_t te_sparks , q_int32_t dflags ) ;
extern q_int32_t CheckPowerArmor ( edict_t * ent , vec3_t point , vec3_t normal , q_int32_t damage , q_int32_t dflags ) ;
extern void SpawnDamage ( q_int32_t type , vec3_t origin , vec3_t normal ) ;
extern void Killed ( edict_t * targ , edict_t * inflictor , edict_t * attacker , q_int32_t damage , vec3_t point ) ;
...
extern q_int32_t PlayerSort ( void const * a , void const * b ) ;
...
extern void SelectPrevItem ( edict_t * ent , q_int32_t itflags ) ;
extern void SelectNextItem ( edict_t * ent , q_int32_t itflags ) ;
...
extern q_int32_t range ( edict_t * self , edict_t * other ) ;
